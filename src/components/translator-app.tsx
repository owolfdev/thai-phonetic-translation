    ...
    <main className="mx-auto flex w-full max-w-3xl flex-1 flex-col px-4 py-5 sm:px-6 sm:py-8">
      <section className="flex flex-col gap-4">
        {result && isResultVisible ? (
          <div className="paper-panel flex flex-col gap-4">
            <>
              <div className="flex items-start justify-between gap-3">
                <div>
                  <p className="eyebrow">Translation</p>
                  <span className="mt-2 inline-flex rounded-full border border-gold-700/35 bg-gold-500/10 px-3 py-1 text-[11px] font-bold tracking-[0.16em] text-gold-800 uppercase">
                ...
                <button
                  ...
                  className="inline-flex h-10 w-10 items-center justify-center rounded-full border border-teal-900/15 text-teal-900 transition hover:bg-teal-900 hover:text-white focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-teal-800"
                >
                  <CloseIcon />
                </button>
              </div>

              <div className="rounded-3xl border border-teal-900/10 bg-white/80 p-5 shadow-sm">
              ...
              <button
                ...
                aria-label={isSpeaking ? "Stop reading" : "Read Thai text aloud"}
                className="inline-flex w-full items-center justify-center gap-3 rounded-3xl border border-teal-900 bg-teal-900 px-5 py-4 text-base font-bold tracking-[0.14em] text-white uppercase transition hover:bg-teal-800 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-teal-800 disabled:cursor-not-allowed disabled:border-stone-300 disabled:bg-stone-200 disabled:text-stone-500"
              >
              ...
              <details className="rounded-[1.25rem] border border-teal-900/10 bg-white/80 p-4">
                <summary className="cursor-pointer text-xs font-bold tracking-[0.18em] text-stone-700 uppercase">
                  Study details
                </summary>
        ...
        <div className="paper-panel flex flex-col gap-4">
          <div className="space-y-2">
            ...
            <h1 className="text-2xl leading-tight font-bold text-stone-900 sm:text-4xl">
              Type English or phonetic Thai.
            </h1>
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            <label className="block space-y-2" htmlFor="translation-input">
              ...
              <textarea
                ...
                className="min-h-36 w-full rounded-3xl border border-teal-900/20 bg-white/90 px-4 py-4 text-base leading-7 text-stone-900 shadow-sm outline-none transition focus-visible:border-teal-700 focus-visible:ring-2 focus-visible:ring-teal-700/25"
                placeholder="sawasdee khrap or Where is the bathroom?"
              />
            </label>
            ...
            <div className="flex flex-wrap gap-2">
              {EXAMPLES.map((example) => (
                <button
                  ...
                  className="rounded-full border border-teal-900/20 bg-white px-3 py-1.5 text-[11px] font-bold tracking-[0.12em] text-teal-900 uppercase transition hover:bg-teal-900 hover:text-white focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-teal-800"
                >
                  {example}
                </button>
              ))}
            ...
            <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center">
              ...
              {!isInstalled && installPromptEvent ? (
                <button
                  ...
                  className="inline-flex items-center justify-center gap-2 rounded-full border border-gold-700/40 px-5 py-3 text-xs font-bold tracking-[0.18em] text-gold-800 uppercase transition hover:bg-gold-700 hover:text-white focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gold-700"
                >
                  <InstallIcon />
                  Install App
                </button>
